...
import { X, MessageSquare, AlertTriangle, Shield, Zap, Triangle, MapPin, Plane } from "lucide-react";
...
export default function MatchupDetail({ game, onClose, onAskAnalyst }: Props) {
  ...
  const travelA = getTeamTravelInfo(teamA.name);
  const travelB = getTeamTravelInfo(teamB.name);
